...
export const mockVillas: Villa[] = [
    ...
    { id: 'v6', villaNumber: 6, ownerFirstName: 'احمدی', ownerLastName: 'لنج', contact: '0912-112-2387', occupancyStatus: 'rented', tenantFirstName: 'علی', tenantLastName: 'رضایی', tenantContact: '09129876543', isForSale: true, mapPosition: { top: '30%', left: '35%' } },
    ...
    { id: 'v20', villaNumber: 20, ownerFirstName: 'مقصودی', ownerLastName: '', contact: '0911-902-1145', occupancyStatus: 'rented', tenantFirstName: 'مریم', tenantLastName: 'محمدی', tenantContact: '09351112233', isForSale: false, mapPosition: { top: '90%', left: '75%' } },
];
